...
import newCartReducer from "./Slices/CartStorage";
import newShippingReducer from "./Slices/Products/Shipping";
...
const store = configureStore({
  reducer: {
    cart: cartReducer,
    newShipping: newShippingReducer,
    paid: paidReducer,
